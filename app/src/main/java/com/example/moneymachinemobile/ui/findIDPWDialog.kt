...
class findIDPWDialog(context: Context) {
    ...
    fun start() {
        ...
        dlg.setContentView(R.layout.dialog_find_idpw)     //다이얼로그에 사용할 xml 파일을 불러옴
        dlg.setCancelable(false)    //다이얼로그의 바깥 화면을 눌렀을 때 다이얼로그가 닫히지 않도록 함

        val btnOK : Button = dlg.findViewById(R.id.buttonFindOK)
...
//            listener.onOKClicked(true)
        ...
        val btnNG : Button = dlg.findViewById(R.id.buttonFindNG)
